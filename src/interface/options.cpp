...
void print_usage(std::ostream& output) {
    output << "Usage: vallescope2 [options] <input.fa>\n"
           ...
           << "  --max-chain-extension-bp INT  Maximum bundle gap considered for chain extension [1000000]\n"
           ...
           << "  --max-bundle-align-bp INT  Skip bundle alignments longer than this [5000000]\n"
